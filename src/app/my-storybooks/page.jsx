                    ...
                    {storybooks.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {storybooks.map((book) => (
                                <div
                                    key={book._id}
                                    className="group relative bg-slate-950/50 border border-white/10 rounded-xl overflow-hidden hover:border-primary/50 transition-all duration-300 hover:-translate-y-1"
                                >
                                    {/* Cover Image */}
                                    ...
                                    <div className="p-6">
                                        ...
                                        <p className="text-sm text-default-400 mb-4 line-clamp-2">
                                            {book.storyline}
                                        </p>
