        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-4 mb-6">
                <Image src={logo} alt="Zifto Logo" className="h-10 w-auto object-contain" />
              </div>
            ...
            <div>
              ...
              <ul className="space-y-5 text-sm text-slate-400">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:contact@zifto.in" className="hover:text-white transition-colors">contact@zifto.in</a>
                </li>
                <li className="flex items-center gap-3">
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-8 text-sm text-slate-500">
              <a href="#" className="hover:text-[#7080FF] transition-colors">Privacy Policy</a>
              <a href="#" className="hover:text-[#7080FF] transition-colors">Terms of Service</a>
            </div>
          </div>
        </div>
      </footer>
